...
class DoctorDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('RapidCare Doctor'),
        actions: [
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Chip(label: Text(updatedStaff.specialization, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)), backgroundColor: AppTheme.primaryDark, side: BorderSide.none),
              ],
            ),
            const Gap(24),
            ...
            Row(
              children: [
                ...
                const Gap(12),
                Expanded(child: _buildQuickAction(context, 'Alert Log', Icons.history, AppTheme.urgent, () {})),
              ],
            ),
            const Gap(32),

            Text('My Alerts', style: Theme.of(context).textTheme.headlineMedium),
            const Gap(16),
            if (alerts.isEmpty)
              Container(
            ...
            const Gap(32),
            Text('My Patients', style: Theme.of(context).textTheme.headlineMedium),
            const Gap(16),
            if (patients.isEmpty)
